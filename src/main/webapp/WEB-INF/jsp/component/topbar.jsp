...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form:form action="${s:mvcUrl('anuncio.pesquisa').build()}" method="GET"
        ...
        <div class="input-group">
            <input name="cidade" class="form-control bg-light border-0 small"
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow d-sm-none">
            ...
            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                ...
                <form:form class="form-inline mr-auto w-100 navbar-search" action="${s:mvcUrl('anuncio.pesquisa').build()}" method="GET">
                    <div class="input-group">
                        <input type="text" name="cidade" class="form-control bg-light border-0 small"
                               placeholder="Pesquisar por cidade" aria-label="Search"
